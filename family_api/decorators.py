...
from family_api.repositories.family_member_repository import get_by_family_id_and_current_user
...
def is_current_user_in_family(func, family_id_param_name='family_id'):
    ...
    async def wrapper(cls, *args, **kwargs):
        ...
        async with cls.request.app['db'].acquire() as conn:
            family_member_exist = await get_by_family_id_and_current_user(family_id, current_user_uuid, conn)
